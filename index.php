    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top py-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="images/test_logo.jpg" alt="Green Meadows Security Logo" class="company-logo me-2">
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <h5 class="logo-text text-white mb-3">
                        <img src="images/test_logo.jpg" alt="Green Meadows Security Logo" class="company-logo me-2" style="height: 30px;">
                        Security <span class="text-white">Agency</span>
                    </h5>
            ...
            <div class="row py-3">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0 text-light">Designed by <a href="https://www.facebook.com/jc.que.29" class="text-white text-decoration-none">Jemmanuel Cyril D. Que</a></p>
                </div>
            </div>
        </div>
    </footer>
